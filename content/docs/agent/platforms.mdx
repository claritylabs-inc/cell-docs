...
CL-0 SDK's agent system adapts to different communication platforms and interaction modes through the platform/intent model.
...
```typescript
import { PLATFORM_CONFIGS } from "@claritylabs-inc/cl-sdk";
