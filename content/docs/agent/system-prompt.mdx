...
CL-0 SDK provides a modular prompt system for building insurance-aware conversational agents. Prompts are composed from independent modules that adapt to the platform and communication intent.

## Quick start

```typescript
import { buildAgentSystemPrompt } from "@claritylabs-inc/cl-sdk";
import type { AgentContext } from "@claritylabs-inc/cl-sdk";
...
```typescript
import { buildDocumentContext } from "@claritylabs-inc/cl-sdk";
...
```typescript
import { buildConversationMemoryContext } from "@claritylabs-inc/cl-sdk";
...
```typescript
import { buildClassifyMessagePrompt } from "@claritylabs-inc/cl-sdk";
