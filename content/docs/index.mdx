...
Cell is an SDK for AI agents working with insurance. Any product or agent can import it to understand, reason about, and act on insurance. Provider-agnostic — works with Anthropic, OpenAI, Google, or any model via the [Vercel AI SDK](https://sdk.vercel.ai).
