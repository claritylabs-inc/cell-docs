...
CL-0 SDK is an SDK for AI agents working with insurance. Any product or agent can import it to understand, reason about, and act on insurance. Provider-agnostic — works with Anthropic, OpenAI, Google, or any model via the [Vercel AI SDK](https://sdk.vercel.ai).
...
<Cards>
  <Card title="Quickstart" description="Install CL-0 SDK and run your first extraction in minutes." href="/docs/getting-started/quickstart" />
