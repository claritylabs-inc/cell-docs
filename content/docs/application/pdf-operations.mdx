...
CL-0 SDK provides two modes for writing data onto PDFs using `pdf-lib`: **AcroForm filling** for fillable PDFs and **text overlay** for flat/scanned PDFs.
...
import { getAcroFormFields } from "@claritylabs-inc/cl-sdk";
...
```typescript
import { fillAcroForm, type FieldMapping } from "@claritylabs-inc/cl-sdk";
...
```typescript
import { overlayTextOnPdf, type TextOverlay } from "@claritylabs-inc/cl-sdk";
